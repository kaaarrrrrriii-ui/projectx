...
export default async function AppealDescription({ searchParams }: {
      ...
      <section className="flex-1 bg-[url('/images/appeal-description-bg.svg')] bg-cover bg-center bg-no-repeat px-[4.88%] pt-14 pb-[38px] max-[699px]:px-5 max-[699px]:py-8" aria-labelledby="description-heading">
        <div className="mx-auto w-full max-w-[1440px]">
          ...
          <textarea
            ...
            className="mt-7 block min-h-[260px] w-full resize-y rounded-[15px] border border-[#333] bg-[#fcfdff] px-[13px] py-4 text-[15px] leading-6 text-[#151515] placeholder:text-[#85899f] placeholder:opacity-100 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--color-primary)] max-[699px]:mt-6 max-[699px]:text-[16px]"
          />
          <aside id="description-hint" className="mt-[38px] flex min-h-[49px] items-center gap-2.5 rounded-[15px] border border-[#677aff] bg-[#dfe6ff] px-2.5 py-[9px] text-[15px] leading-[22px] text-[#151515] max-[699px]:mt-6 max-[699px]:items-start max-[699px]:text-[14px]">
            <Image src="/images/LightbulbFilament.svg" alt="" width={28} height={28} className="shrink-0" />
            <p>Нет правильных или неправильных слов. Пиши так, как тебе удобно. Мы внимательно читаем каждое обращение.</p>
          </aside>
