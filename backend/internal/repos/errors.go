...
var (
	...
	ErrInvalidAnswer          = errors.New("answer does not belong to question and category")
	ErrTrackIDExists          = errors.New("track id already exists")
	ErrReviewAlreadyExists    = errors.New("review already exists")
	ErrReviewNotAllowed       = errors.New("review is not allowed for this ticket")
)
